...
int main() {
   ...
   loc = S.indexOf(531) ;
   if (loc == 77) {
      cerr << "#887134##X   ==  -0: correctly reported the index of 531 to be 77 .\n" ;
   } else {
      cerr << "#887134##X   ==  -1: incorrectly reported the index of 531 as " << loc << " (should be 77).\n" ;
   }
   
   loc = S.indexOf(999) ;
   if (loc == -1) {
      cerr << "#887134##X   ==  -0: correctly reported the index of 999 to be -1 (not found).\n" ;
   } else {
      cerr << "#887134##X   ==  -1: incorrectly reported the index of 999 as " << loc << " (should be -1, not found).\n" ;
   }
